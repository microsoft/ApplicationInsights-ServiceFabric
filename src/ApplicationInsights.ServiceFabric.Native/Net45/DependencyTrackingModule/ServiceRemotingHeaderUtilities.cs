...
namespace Microsoft.ApplicationInsights.ServiceFabric.Module
{
    ...
    {
        internal static IEnumerable<string> GetHeaderValues(IServiceRemotingMessageHeaderCollection headers, string headerName)
        {
            string result;
        ...
        internal static string GetHeaderKeyValue(IServiceRemotingMessageHeaderCollection headers, string headerName, string keyName)
        {
            IEnumerable<string> headerValues = GetHeaderValues(headers, headerName);
            return GetHeaderKeyValue(headerValues, keyName);
        }

        internal static string GetRequestContextKeyValue(IServiceRemotingMessageHeaderCollection headers, string keyName)
        {
            return GetHeaderKeyValue(headers, RequestResponseHeaders.RequestContextHeader, keyName);
        }

        internal static bool ContainsHeaderKeyValue(IServiceRemotingMessageHeaderCollection headers, string headerName, string keyName)
        {
            return !string.IsNullOrEmpty(GetHeaderKeyValue(headers, headerName, keyName));
        }

        internal static bool ContainsRequestContextKeyValue(IServiceRemotingMessageHeaderCollection headers, string keyName)
        {
            return ContainsHeaderKeyValue(headers, RequestResponseHeaders.RequestContextHeader, keyName);
        }

        internal static void SetRequestContextKeyValue(IServiceRemotingMessageHeaderCollection headers, string keyName, string keyValue)
        {
            SetHeaderKeyValue(headers, RequestResponseHeaders.RequestContextHeader, keyName, keyValue);
        }

        internal static void SetHeaderKeyValue(IServiceRemotingMessageHeaderCollection headers, string headerName, string keyName, string keyValue)
        {
            if (headers == null)
            {
        ...
        public static string UpdateHeaderWithKeyValue(IEnumerable<string> headerValues, string keyName, string keyValue)
        {
